...
import ru.vafeen.universityschedule.last.database.ReminderType
...
import ru.vafeen.universityschedule.last.noui.duration.RepeatDuration
...
fun Lesson.createReminderBefore15MinutesOfLesson(
    ...
    dt = dt,
    type = ru.vafeen.universityschedule.last.database.ReminderType.BEFORE_LESSON,
...
fun Lesson.createReminderAfterStartingLessonForBeCheckedAtThisLesson(
    ...
    dt = dt,
    type = ru.vafeen.universityschedule.last.database.ReminderType.AFTER_BEGINNING_LESSON,
    duration = if (frequency == Frequency.Every) RepeatDuration.EVERY_WEEK else RepeatDuration.EVERY_2_WEEKS
)
